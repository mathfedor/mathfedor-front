      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            <Link href="/registro" className="text-lg font-medium text-orange-600 hover:text-orange-500">
              {t('subtitle')}
            </Link>
          </p>
        </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-50 text-gray-500">{t('or_continue_with')}</span>
              </div>
            </div>
