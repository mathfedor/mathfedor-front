...
export default function BuyBooksPage() {
    ...
    const t = useTranslations('dashboard.buybooks');
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className="text-xl font-bold text-gray-900">{t('content_title')}</p>
                                                        <p className="mt-1 text-sm text-gray-600">{t('content_desc')}</p>
                                                    </div>
                                                </div>
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className="text-xl font-bold text-gray-900">{t('benefits_title')}</p>
                                                        <p className="mt-1 text-sm text-gray-600">{t('benefits_desc')}</p>
                                                    </div>
                                                </div>
                                                <span className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-orange-400 text-xl text-orange-500 transition group-hover:bg-orange-50">
                                                    →
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className="text-xl font-bold text-gray-900">{t('ficha_title')}</p>
                                                        <p className="mt-1 text-sm text-gray-600">{t('ficha_desc')}</p>
                                                    </div>
                                                </div>
                                                <span className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-orange-400 text-xl text-orange-500 transition group-hover:bg-orange-50">
                                                    →
