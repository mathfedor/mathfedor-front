...
export default function RetosPublicosPage() {
  const t = useTranslations('retos.public');
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-white">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  {t('hero_title_1')}
                  <br />
                  <span className="text-orange-300">{t('hero_title_2')}</span>
                  <br />
                  {t('hero_title_3')}
                  <br />
                  {t('hero_title_4')}
      ...
      <main className="py-12 flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            {/* Columna de texto */}
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-8">{t('section_title')}</h1>
