    ...
    <>
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
        ...
        <section className="relative h-[600px] w-full overflow-hidden">
          <Image
            src="/home-image.png"
            alt={`${t('hero.title_line1')} ${t('hero.title_highlight')} ${t('hero.title_line2')}`}
            fill
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-12 text-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.tech_title')}</h3>
                <p className="text-gray-600">
                  {t('features.tech_desc')}
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.curriculum_title')}</h3>
                <p className="text-gray-600">
                  {t('features.curriculum_desc')}
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.autonomy_title')}</h3>
                <p className="text-gray-600">
                  {t('features.autonomy_desc')}
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.icfes_title')}</h3>
                <p className="text-gray-600">
                  {t('features.icfes_desc')}
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.university_title')}</h3>
                <p className="text-gray-600">
                  {t('features.university_desc')}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center mt-16">
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.reinforce_title')}</h3>
                <p className="text-gray-600">
                  {t('features.reinforce_desc')}
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.prep_title')}</h3>
                <p className="text-gray-600">
                  {t('features.prep_desc')}
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.recover_title')}</h3>
                <p className="text-gray-600">
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">{t('features.accelerated_title')}</h3>
                <p className="text-gray-600">
                  {t('features.accelerated_desc')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <p className="text-gray-600 italic mb-3">
                    {t('testimonials.test1_quote')}
                  </p>
                  <p className="font-semibold text-gray-900">- {t('testimonials.test1_author')}</p>
                  <p className="text-sm text-gray-500">{t('testimonials.test1_role')}</p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <p className="text-gray-600 italic mb-3">
                    {t('testimonials.test2_quote')}
                  </p>
                  <p className="font-semibold text-gray-900">- {t('testimonials.test2_author')}</p>
                  <p className="text-sm text-gray-500">{t('testimonials.test2_role')}</p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <p className="text-gray-600 italic mb-3">
                    {t('testimonials.test3_quote')}
                  </p>
                  <p className="font-semibold text-gray-900">- {t('testimonials.test3_author')}</p>
                  <p className="text-sm text-gray-500">{t('testimonials.test3_role')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-orange-500 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <div className="text-5xl font-bold mb-2">{t('stats.satisfied_count')}</div>
                <div className="text-xl">{t('stats.satisfied_label')}</div>
              </div>
              <div>
                <div className="text-5xl font-bold mb-2">{t('stats.pass_rate')}</div>
                <div className="text-xl">{t('stats.pass_rate_label')}</div>
              </div>
              <div>
                <div className="text-5xl font-bold mb-2">{t('stats.rating_val')}</div>
                <div className="text-xl">{t('stats.rating_label')}</div>
              </div>
            </div>
          </div>
        </section>
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-white p-5">
                    <div className="mb-4 rounded-2xl bg-white/90 px-4 py-3 text-center shadow-sm border border-orange-100/80 backdrop-blur-sm">
                      <p className="text-sm sm:text-base font-extrabold uppercase tracking-wide text-gray-900 leading-snug">
                        {module.group === 'Grado1'
                          ? t('catalog.grado1_books')
                          : t('catalog.other_books')}
                      </p>
                    </div>
                      ...
                      <div className="space-y-3">
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="text-xl font-bold text-gray-900">{t('catalog.content_btn')}</p>
                              <p className="mt-1 text-sm text-gray-600">{t('catalog.content_desc')}</p>
                            </div>
                          </div>
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="text-xl font-bold text-gray-900">{t('catalog.benefits_btn')}</p>
                              <p className="mt-1 text-sm text-gray-600">{t('catalog.benefits_desc')}</p>
                            </div>
                          </div>
                          <span className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-orange-400 text-xl text-orange-500 transition group-hover:bg-orange-50">
                            →
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="text-xl font-bold text-gray-900">{t('catalog.ficha_btn')}</p>
                              <p className="mt-1 text-sm text-gray-600">{t('catalog.ficha_desc')}</p>
                            </div>
                          </div>
                          <span className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-orange-400 text-xl text-orange-500 transition group-hover:bg-orange-50">
                            →
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <h3 className="text-xl font-bold text-center mb-3 text-gray-900">{t('international.global_title')}</h3>
                <p className="text-gray-600 text-center">
                  {t('international.global_desc')}
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <h3 className="text-xl font-bold text-center mb-3 text-gray-900">{t('international.standards_title')}</h3>
                <p className="text-gray-600 text-center">
                  {t('international.standards_desc')}
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <h3 className="text-xl font-bold text-center mb-3 text-gray-900">{t('international.culture_title')}</h3>
                <p className="text-gray-600 text-center">
                  {t('international.culture_desc')}
                </p>
              </div>
            </div>
            ...
            <div className="text-center mt-12">
              <p className="text-lg text-gray-700 mb-6">
                <strong>{t('international.revolution_call')}</strong>
              </p>
              <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600">
                <span className="bg-white px-4 py-2 rounded-full shadow">{t('international.badge_latam')}</span>
                <span className="bg-white px-4 py-2 rounded-full shadow">{t('international.badge_spain')}</span>
                <span className="bg-white px-4 py-2 rounded-full shadow">{t('international.badge_more')}</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                onClick={() => {
                  trackMetaContact({ content_name: 'WhatsApp (Libros CTA)' });
                  trackTikTokContact({ description: 'WhatsApp (Libros CTA)' });
        ...
        <a
          ...
          rel="noopener noreferrer"
          onClick={() => {
            trackMetaContact({ content_name: 'WhatsApp Flotante (Libros)' });
            trackTikTokContact({ description: 'WhatsApp Flotante (Libros)' });
            trackGTMGenerateLead({ method: 'WhatsApp', value: 0, currency: 'COP' });
          }}
