...
export default function LandingGrado2() {
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.fbq) {
        window.fbq('track', 'CompleteRegistration', {
          content_name: 'modulo_gratis_grado_2',
          status: true,
        });
      }
  ...
  return (
    <>
                ...
                <div>
                  ...
                  <div className="bg-emerald-950/40 border border-emerald-500/30 rounded-xl p-3.5 mb-5 text-xs sm:text-sm text-emerald-100 leading-relaxed">
                    <p className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-emerald-300">Importante:</strong> El módulo gratuito es <strong>solo el libro digital dentro de la plataforma</strong> para estudiar y practicar en línea (no incluye descargas de libros en PDF ni guías de problemas).
                      </span>
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-orange-950/40 border border-orange-500/30 rounded-xl p-3.5 mb-3 text-xs sm:text-sm text-orange-100 leading-relaxed">
                    <p className="flex items-start gap-2">
                      <span className="text-base shrink-0">🎓</span>
                      <span>
                        <strong className="text-orange-300">Módulo completo:</strong> Viene con el módulo completo, es decir, el <strong>libro digital interactivo</strong> y todas las <strong>descargas de ayuda</strong> (3 libros PDF imprimibles, guías de problemas cotidianos y cálculo mental).
                      </span>
                    </p>
                  </div>
      ...
      {/* =================================================================== */}
      {/* MODAL DE REGISTRO RÁPIDO PARA EL MÓDULO GRATUITO 2° */}
      {/* =================================================================== */}
      {showRegisterModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl relative border border-gray-100">
            ...
            <div className="text-center mb-6">
              <span className="text-xs font-black text-emerald-700 uppercase tracking-wider bg-emerald-100 px-3.5 py-1.5 rounded-full inline-block">
                🎁 Acceso Gratuito • Libro Digital 2°
              </span>
              <h3 className="text-2xl font-black text-gray-900 mt-2 font-['Baloo_2',sans-serif]">
                Crea tu cuenta de acceso gratis
              </h3>
              <p className="text-gray-600 text-xs mt-1.5 leading-relaxed">
                Podrás ingresar a practicar y estudiar con el <strong>libro digital interactivo de 2° Primaria</strong> en línea sin costo.
              </p>
            </div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-4 text-[12px] text-amber-900 leading-snug">
              <span className="font-bold">Nota:</span> Esta modalidad gratuita te da acceso al <strong>libro digital dentro de la plataforma</strong>. Si luego deseas descargar los 3 libros en PDF y guías de problemas, podrás adquirir el módulo completo.
            </div>
            ...
            {registerSuccess ? (
              ...
              <form onSubmit={handleFreeRegister} className="space-y-4">
                ...
                <div className="flex items-start gap-2.5 pt-1">
                  ...
                  />
                  <label htmlFor="terms-check-2" className="text-[11px] text-gray-600 leading-snug cursor-pointer">
                    Acepto los{' '}
