...
export const DEFAULT_DAILY_MISSIONS_3RO: DailyMission3ro[] = [
  {
    id: 'm_ejercicios',
    title: 'Práctica Galáctica',
    desc: 'Resuelve 5 ejercicios en cualquier unidad',
    xpReward: 30,
    coinsReward: 15,
    icon: '🎯',
    goal: 5,
  ...
  },
  {
    ...
    desc: 'Mantén tu racha de estudio activa hoy',
    xpReward: 40,
    coinsReward: 20,
    icon: '🔥',
    goal: 1,
  ...
  },
  {
    ...
    desc: 'Consigue 3 estrellas en una lección',
    xpReward: 50,
    coinsReward: 25,
    icon: '⭐',
    goal: 3,
  ...
  {
    id: 'm_problemas',
    title: 'Mundo Cotidiano',
    desc: 'Resuelve un problema de la vida cotidiana',
    xpReward: 35,
    coinsReward: 15,
    icon: '🧮',
    goal: 1,
  ...
  {
    id: 'm_maraton',
    title: 'Especialista SABER',
    desc: 'Prueba tu velocidad en el Modo Maratón',
    xpReward: 80,
    coinsReward: 50,
    icon: '🏃',
    goal: 1,
