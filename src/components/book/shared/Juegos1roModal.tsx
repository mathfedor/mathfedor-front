...
interface Juegos1roModalProps {
  onClose: () => void;
  onSelectOption: (optionId: 'stats' | 'tablas' | 'conteo' | 'retos') => void;
}

export default function Juegos1roModal({ onClose, onSelectOption }: Juegos1roModalProps) {
  return (
    <div
      style={{
        position: 'fixed',
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.2rem' }}>
          ...
          <div style={{ fontSize: '12px', color: '#7A7299', fontWeight: 700, marginTop: '3px' }}>
        ...
        <div style={{ display: 'grid', gap: '10px' }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 6px 16px rgba(108, 40, 180, 0.15)';
            }}
            onMouseLeave={(e) => {
          ...
          >
            <div style={{ flexShrink: 0, width: '38px', height: '38px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg viewBox="0 0 48 48" style={{ width: '36px', height: '36px', filter: 'drop-shadow(0 2px 4px rgba(74, 222, 128, 0.3))' }} fill="none">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: '15px', fontWeight: 900, color: '#3D1468', lineHeight: 1.2 }}>
                Laboratorio de Estadística
              </div>
              <div style={{ fontSize: '11px', color: '#7A7299', fontWeight: 700, marginTop: '2px' }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = 'scale(1.02)';
              e.currentTarget.style.boxShadow = '0 6px 16px rgba(232, 101, 10, 0.15)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'scale(1)';
              e.currentTarget.style.boxShadow = 'none';
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: '15px', fontWeight: 900, color: '#7A3200', lineHeight: 1.2 }}>
                Tablas Mágicas
              </div>
              <div style={{ fontSize: '11px', color: '#7A7299', fontWeight: 700, marginTop: '2px' }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = 'scale(1.02)';
              e.currentTarget.style.boxShadow = '0 6px 16px rgba(22, 135, 106, 0.15)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'scale(1)';
              e.currentTarget.style.boxShadow = 'none';
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: '15px', fontWeight: 900, color: '#074F3A', lineHeight: 1.2 }}>
                Tablas de Conteo
              </div>
              <div style={{ fontSize: '11px', color: '#7A7299', fontWeight: 700, marginTop: '2px' }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = 'scale(1.02)';
              e.currentTarget.style.boxShadow = '0 6px 16px rgba(201, 75, 34, 0.15)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'scale(1)';
              e.currentTarget.style.boxShadow = 'none';
          ...
          >
            <div style={{ flexShrink: 0, width: '38px', height: '38px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg viewBox="0 0 48 48" style={{ width: '36px', height: '36px', filter: 'drop-shadow(0 2px 4px rgba(244, 63, 94, 0.3))' }} fill="none">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: '15px', fontWeight: 900, color: '#7A1B00', lineHeight: 1.2 }}>
                Retos Matemáticos
              </div>
              <div style={{ fontSize: '11px', color: '#7A7299', fontWeight: 700, marginTop: '2px' }}>
